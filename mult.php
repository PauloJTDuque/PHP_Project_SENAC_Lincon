...
<head>
    ...
    <title>Função Multiplicação</title>
</head>

<body>
    <div class="jumbotron">
        <h1 class="display-4" style="color: orange;">Função Multiplicação</h1>
        <p class="lead">Aqui você irá incluir os valores para a Multiplicação</p>
        <hr>
    </div>
    <div class="col-md-4">
    <h2 style="text-align: center; color: orange;">Resultado da Multiplicação</h2>
                    <hr>
        <form method="get" action="mult.php" name="form" id="form">
            ...
            <div class="form-group">
                <label for="totalmult">Total da Multiplicação</label>
                <input type="number" name="totalmult" style="font-size: 24px; color:orange" class="form-control" value="<?php echo mult($var1, $var2); ?>" / readonly>
